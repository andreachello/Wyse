...
import type { ArtifactKind } from '@/app/(chat)/components/artifacts/artifact';
import { generateUUID } from '../utils';
import { generateHashedPassword } from './utils';
import type { VisibilityType } from '@/app/(chat)/components/chat-header/visibility-selector';
