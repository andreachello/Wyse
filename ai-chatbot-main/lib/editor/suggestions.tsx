...
import { Suggestion as PreviewSuggestion } from '@/components/artifacts/text/components/suggestion';
import type { Suggestion } from '@/lib/db/schema';
import { ArtifactKind } from '@/app/(chat)/components/artifacts/artifact';
